...
export default function NotFound() {
  return (
    <main className="flex-grow flex flex-col items-center justify-center min-h-[80vh] px-6 text-center relative overflow-hidden">
      ...
      <p className="font-jakarta text-body-lg text-on-surface-variant font-light max-w-md mx-auto mb-10 leading-relaxed">
