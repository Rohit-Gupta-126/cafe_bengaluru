...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#111A13] text-[#FAF9F6] border-t border-white/5 overflow-hidden z-20">
      ...
      <div className="max-w-container-max mx-auto px-lg pt-20 pb-10 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-12 gap-x-8 lg:gap-x-0 pb-16 border-b border-white/10">
